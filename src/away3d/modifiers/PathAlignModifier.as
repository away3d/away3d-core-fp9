package away3d.modifiers
{
	...
	public class PathAlignModifier
	{
		...
		public function findClosestCurveOffsetToPoint(point:Number3D):Object
		{
			...
			var distancesArr:Array = BezierUtils.getArcLengthArray(_commands[minimunDistanceIndex], 0.1);
		...
		{
			var snapshot:Array = _cacheRef[xOffset];
