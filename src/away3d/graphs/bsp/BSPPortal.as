package away3d.graphs.bsp
{
	...
	public final class BSPPortal extends EventDispatcher
	{
		...
		public function split(plane : Plane3D) : Array
		{
			...
			var splits : Array = nGon.split(plane);
			var ngon : NGon;
			var newPortals : Array = new Array();
		...
		{
			var backPortals : Array = frontNode._backPortals;
		...
		private function findVisiblePortalStep() : void
		{
			...
			do {
				...
				if (_state == TRAVERSE_PRE) {
					...
					// clear memory
					var pl : Plane3D;
					var anti : Array = _currentPortal._currentAntiPenumbra;
		 ...
		 */
		private function generateAntiPenumbra(targetNGon : NGon) : Array
		{
			var anti : Array = new Array();
			var vertices1 : Array = nGon.vertices;
			var vertices2 : Array = targetNGon.vertices;
...
//					plane.normalize();
		...
		public function propagateVisibility() : void
		{
			var j : int;
			var k : int;
			var list : Array = new Array(listLen);
		 ...
		 */
		private function checkAgainstAntiPenumbra(antiPenumbra : Array) : Boolean
		{
